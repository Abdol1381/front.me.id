...
<section style="font-weight: lighter; font-family: Montserrat, sans-serif; visibility: visible; animation-duration: 2s; animation-name: fadeInDown;" id="toper" class="header  navigation wow fadeInDown" data-wow-duration="2s">
 ...
 <section class="contact-us section bg-gray" id="contact">
			...
			<div class="row">
				<div class="col">
					<div class="title text-center">
						<p>Do you have a question or want to share your feedback with us?
            <br>You are welcome to contact us in one of the following ways:</p>
					</div>
				</div>
			</div>
			<div class="row">
				...
				<div class="contact-form col-12 col-md-6  mx-auto">
						...
						<div class="form-group">
							<input type="text" placeholder="Your Name" class="form-control" name="fullname" required="">
						</div>
						...
						<div id="cf-submit">
							<input type="submit" name="send" id="contact_us" class="btn btn-success" value="Submit">
						</div>						
        ...
        <div class="col-md-6" style="border-left: 1px solid #ccc; padding-left: 5px;">
