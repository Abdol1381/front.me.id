...
<section style="font-weight: lighter; font-family: Montserrat, sans-serif; visibility: visible; animation-duration: 2s; animation-name: fadeInDown;" id="toper" class="header  navigation wow fadeInDown" data-wow-duration="2s">
 ...
 <section class="page-wrapper section" style="background-color: #f2f2f2!important;">
	<div class="container">
        ...
        <div class="panel panel-default gen-quest">
        <div class="panel-heading">
          <div class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion4" href="#collapse41">
            Is Coinbitory.com legit?
          <i class="material-icons fa fa-plus"></i></a>
          </div>
        </div>

        <div id="collapse41" class="panel-collapse collapse">
          <div class="panel-body">
          <p>Coinbitory.com is a legal investment company incorporated in the United Kingdom.<br>Registration number: 11445991.<br>Office address: 66 GREAT SUFFOLK STREET, LONDON, UNITED KINGDOM, SE1 0BL.</p>
          </div>
        </div>
        </div>
        <div class="panel panel-default gen-quest">
        <div class="panel-heading">
          ...
          <a data-toggle="collapse" data-parent="#accordion4" href="#collapse43">
            Who may be a client of Coinbitory.com?
          <i class="material-icons fa fa-plus"></i></a>
          </div>
        </div>
        <div id="collapse43" class="panel-collapse collapse">
          <div class="panel-body">
          <p>Everyone may be a client of Coinbitory.com, but he\she must be not less 18 years old.</p>
          </div>
        </div>
        </div>
        ...
        <div class="panel-heading">
          <div class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion4" href="#collapse44">
            How may I become a client of Coinbitory.com?
          <i class="material-icons fa fa-plus"></i></a>
          </div>
        </div>
        <div id="collapse44" class="panel-collapse collapse">
          <div class="panel-body">
          <p>You may become a client of Coinbitory.com and it is totally free of charge. All you need is to <a href="register.php">open an account<i class="material-icons fa fa-link"></i></a> and fill all required fields.</p>
          </div>
        </div>
        </div>
        ...
        <div class="panel-heading">
          <div class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion4" href="#collapse46">
            I have trouble during registering. What shall I do?
          <i class="material-icons fa fa-plus"></i></a>
        </div>
        </div>
        <div id="collapse46" class="panel-collapse collapse">
          <div class="panel-body">
          <p>Check the entered information. Displayed errors can help you, they show where you have made mistakes.<br>
          Sometimes it could be browser issue. Try to change your browser or turn off any translator if you use it.<br>
          If you need further assistance don't hesitate to <a href="contact.php">contact us<i class="material-icons fa fa-support"></i></a>.</p>
          </div>
        </div>
        </div>
        ...
        <div class="panel-heading">
          <div class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion4" href="#collapse47">
        ...
        <div id="collapse47" class="panel-collapse collapse">
          <div class="panel-body">
          <p>Your account will be active immediately after registration.</p>
          </div>
        </div>
        </div>
        
        <div class="panel panel-default acc-quest">
        <div class="panel-heading">
          <div class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion4" href="#collapse48">
        ...
        <div id="collapse48" class="panel-collapse collapse">
          <div class="panel-body">
          <p>You may log into your account by clicking the link <a href="login.php">Login<i class="material-icons fa fa-link"></i></a> and enter your username and password.</p>
          </div>
        </div>
        </div>
        <div class="panel panel-default acc-quest">
        <div class="panel-heading">
          <div class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion4" href="#collapse49">
        ...
        <div id="collapse49" class="panel-collapse collapse">
          <div class="panel-body">
          <p>In order to control your account you need to use navigation menu in the left side of our site.</p>
          </div>
        </div>
        </div>
        <div class="panel panel-default acc-quest">
        <div class="panel-heading">
          <div class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion4" href="#collapse410">
            May I change my login data?
          <i class="material-icons fa fa-plus"></i></a>
          </div>
        </div>
        <div id="collapse410" class="panel-collapse collapse">
          <div class="panel-body">
          <p>You may change your password by clicking the link Update Details in the navigation menu (you need to be logged into your account first).<br>In order to change your payment accounts data you need to <a href="contact.php">contact our support service<i class="material-icons fa-support"></i></a>.</p>
          </div>
        </div>
        </div>
        <div class="panel panel-default acc-quest">
        ...
        <div id="collapse410" class="panel-collapse collapse">
          <div class="panel-body">
          <p>All stored data on our servers remains protected via encryption technology all the time.<br>All account related transactions done by our clients are mediated exclusively via secured internet connections</p>
          </div>
        </div>
        </div>
        <div class="panel panel-default acc-quest">
        <div class="panel-heading">
          <div class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion4" href="#collapse411">
        ...
        <div id="collapse411" class="panel-collapse collapse">
          <div class="panel-body">
          <p>Click <a href="forgot-password.php">password recovery<i class="material-icons fa fa-link"></i></a> link, type your email and you should receive reset password link.<br>If you haven't receive password reset link check your spam folder or <a href="contact.php">contact our support service<i class="material-icons fa fa-link"></i></a>.</p>
          </div>
        </div>
        </div>
        <div class="panel panel-default acc-quest">
        <div class="panel-heading">
          <div class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion4" href="#collapse412">
        ...
        <div id="collapse412" class="panel-collapse collapse">
          <div class="panel-body">
          <p>Any client can have only one account per IP/Family/Payment account. In the event of multiple registrations from your computer we have rights to suspend all of your accounts.</p>
          </div>
        </div>
        </div>
        <div class="panel panel-default inv-quest">
        <div class="panel-heading">
          <div class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion4" href="#collapse413">
        ...
        <div id="collapse413" class="panel-collapse collapse">
          <div class="panel-body">
          <p>In order to make a deposit click on Fund Account in the navigation menu.<br>Fill desired amount in the 'Amount' field, choose payment system that you use and click 'Confirm'. Follow further instructions of your payment system.</p>
          </div>
        </div>
        </div>
        <div class="panel panel-default inv-quest">
        <div class="panel-heading">
          <div class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion4" href="#collapse414">
        ...
        <div id="collapse414" class="panel-collapse collapse">
          <div class="panel-body">
          <p>Your deposit should be activated immediately.<br>For deposits in bitcoin it could be some time lag which is required for getting confirmations by bitcoin network.<br>If your deposit hasn't appear in your account for a long time, please <a href="contact.php">contact us<i class="material-icons fa fa-support"></i></a>.</p>
          </div>
        </div>
        </div>
        ...
        <div class="panel-heading">
          <div class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion4" href="#collapse417">
            Does the profit include my initial deposit?
            <i class="material-icons fa fa-plus"></i></a>
          </div>
        </div>
        <div id="collapse417" class="panel-collapse collapse">
          <div class="panel-body">
          <p>In all investment plans your profit includes your initial deposit.</p>
          </div>
        </div>
        </div>
        <div class="panel panel-default inv-quest">
        <div class="panel-heading">
          <div class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion4" href="#collapse418">
            May I have several deposits at the same time?
           <i class="material-icons fa fa-plus"></i></a>
          </div>
        </div>
        <div id="collapse418" class="panel-collapse collapse">
          <div class="panel-body">
          <p>Yes, sure you may have as many deposits as you want.</p>
          </div>
        </div>
        </div>
        ...
        <div class="panel-heading">
          <div class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion4" href="#collapse420">
            Which electronic currencies do you accept at the moment?
          <i class="material-icons fa fa-plus"></i></a>
          </div>
        </div>
        <div id="collapse420" class="panel-collapse collapse">
          <div class="panel-body">
          <p>At the moment we accept: Bitcoin Cash, Litecoin, Dash and Ethereum.</p>
          </div>
        </div>
        </div>
        <div class="panel panel-default inv-quest">
        <div class="panel-heading">
          <div class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion4" href="#collapse421">
        ...
        <div id="collapse421" class="panel-collapse collapse">
          <div class="panel-body">
          <p>In order to withdraw your profit you need to make withdrawal request on Withdraw page in your member area.<br>Just fill desired withdrawing amount and choose payment system which you use for making your deposits.</p>
          </div>
        </div>
        </div>
        <div class="panel panel-default inv-quest">
        <div class="panel-heading">
          <div class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion4" href="#collapse422">
        ...
        <div id="collapse422" class="panel-collapse collapse">
          <div class="panel-body">
          <p>Your request will be processed within 24 hours.<br>We do everything possible to reduce awaiting time of our clients.</p>
          </div>
        </div>
        </div>
        <div class="panel panel-default inv-quest">
        <div class="panel-heading">
          <div class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion4" href="#collapse423">
            I requested for a withdrawal some time ago, but money haven't come yet.
                    <i class="material-icons fa fa-plus"></i></a>
          </div>
        </div>
        <div id="collapse423" class="panel-collapse collapse">
          <div class="panel-body">
          <p>Please, pay attention that usually we process withdrawals within 24 hours.<br>But anyway <a href="contact.php">contact our support service<i class="material-icons fa fa-support"></i></a> and we will check your issue.</p>
          </div>
        </div>
        </div>
        <div class="panel panel-default inv-quest">
        <div class="panel-heading">
          <div class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion4" href="#collapse424">
        ...
        <div id="collapse424" class="panel-collapse collapse">
          <div class="panel-body">
          <p>No. We don't have any withdrawal limits and it is totally free of charge.</p>
          </div>
        </div>
        </div>
