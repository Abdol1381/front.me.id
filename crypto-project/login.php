...
<section style="font-weight: lighter; font-family: Montserrat, sans-serif; visibility: visible; animation-duration: 2s; animation-name: fadeInDown;" id="toper" class="header  navigation wow fadeInDown" data-wow-duration="2s">
 ...
 <div class="container" style="padding-top: 5%; background-color: #e2e2e2">
  <!-- <div id="success"  class="alert alert-success" role="alert" ><strong>Well Done! </strong></div> -->
    ...
    <div class="col-md-7" style="padding-bottom: 2%">
            ...
            <div>
                <form action="inc/functions.php" method="POST">
                    <input type="hidden" name="csrf_token" value="0022db42774407bfc5435b58e82a9496"> 
                    <div class="">
                        <div class="form-group">
                            <label style="font-family: 'Montserrat', sans-serif">Email</label>
                            <input class="form-control" style="color: #000; height: 3.25rem; border-radius: 0px; border: 1px solid #ccc; font-family: 'Montserrat', sans-serif" placeholder="Enter your Email" type="email" name="email">
                        </div>
                        <div class="form-group">
                            <label style="font-family: 'Montserrat', sans-serif;">Password</label>
                            <input class="form-control" style="color: #000; height: 3.25rem; border-radius: 0px; border: 1px solid #ccc; font-family: 'Montserrat', sans-serif" placeholder="Enter your Password" type="password" name="password">
                        </div>
                        
                        <div class="row mb-4 rmber-area">
                            <div class="col-6">
                                <div class="custom-control custom-checkbox mr-sm-2">
                                    <input style="background-color: #ccc!important" type="checkbox" class="custom-control-input" id="customControlAutosizing">
                                    <label style="font-family: 'Montserrat', sans-serif;" class="custom-control-label" for="customControlAutosizing">Remember Me</label>
                                </div>
                            </div>
                            <div class="col-6 text-right">
                                <a style="font-family: 'Montserrat', sans-serif;" href="forgot-password.php">Forgot Password?</a>
                            </div>
                        </div>

                        <div class="submit-btn-area">
                            <center><button style="margin-top: 20px; cursor: pointer;   font-family: 'Chivo', sans-serif; border-radius: 0px" class="blue-button-solid" id="form_submit" name="login" type="submit">LOGIN <i class="fa fa-chevron-right"></i></button>
                            </center>
                        </div>
                        <div class="form-footer text-center mt-5">
                            <p class="text-muted" style="font-family: 'Montserrat', sans-serif;">Don't have an account? <a style="font-family: 'Montserrat', sans-serif;" href="register.php">Sign up</a></p>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <div style="background-image: url('images/icons/reg-banner.jpg'); background-repeat: no-repeat; background-size: contain;" class="col-md-3">
